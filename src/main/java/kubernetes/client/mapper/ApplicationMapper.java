...
public interface ApplicationMapper {
	...
	@Results({ @Result(property = "id", column = "app_id"), @Result(property = "name", column = "app_name"),
			@Result(property = "descrition", column = "descrition"), @Result(property = "proAutoscaler", column = "pro_autoscaler") })
	...
	@Update("UPDATE application SET description =#{description}, pro_autoscaler =#{proAutoscaler}  WHERE app_id =#{id}")
